...
import {FETCH_COUNTRIES_SUCCESS, CountryActions, FETCH_COUNTRIES_FAILURE, FETCH_COUNTRIES_LOADING} from '../../types/CountryTypes'
...
export function fetchAllCountries(){
    ...
    return (dispatch:Dispatch)=>{
        ...
        //axios call 
        axios.get('https://localhost:6001/api/v1/Country')
        .then((res)=>{
